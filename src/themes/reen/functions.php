...
if ( ! function_exists( 'reen_setup' ) ) :
	...
	function reen_setup() {
		 ...
		 * If you're building a theme based on REEN, use a find and replace
		 * to change 'reen' to the name of your theme in all the template files.
		 */
...
add_action( 'after_setup_theme', 'reen_setup' );
...
add_action( 'widgets_init', 'reen_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function reen_scripts() {
	wp_enqueue_style( 'reen-style', get_stylesheet_uri() );
...
add_action( 'wp_enqueue_scripts', 'reen_scripts' );
